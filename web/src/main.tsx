...
import {
  type Account, type Client, type ClientConfirmation, type ClientDialog, type ClientKind,
  type ClientResult, clientNameOrId, isConfidentialClient, oauthQuery, providerReturnTo, request, useSession,
} from "./api";
import { Button, CopyIcon, EmailVerificationModal, ErrorText, Layout, Modal } from "./components";
import "./style.css";
